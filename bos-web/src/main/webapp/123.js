        ...
        k.prototype = {
                            ...
                            case "_trackPageview":
                                if (a[1]) {
                                    ...
                                    if ("" === a[2])
                                        ...
                                        var b = a[2];
                                        "http" !== b.substr(0, 4) && (b = scheme + "//" + e.location.host,
                                        "/" !== a[2].charAt(0) && (b += "/"),
                                            b += a[2]);
                                        this.a.g = b
                                    }
            ...
            ta: function() {
                try {
                    ...
                    0 < this.U() && 432E5 < (new Date).getTime() - this.U() && (this.a.B++,
            ...
            $: function() {
                try {
                    ...
                    if (1E8 < this.c) {
                        ...
                        "none" !== this.a.l ? b.push("cnzz_eid=" + f(this.a.l)) : (d = Math.floor(2147483648 * Math.random()) + "-" + this.C + "-" + this.N(this.o()),
                            b.push("cnzz_eid=" + f(d))),
                            b.push("ntime=" + this.C),
                            0 < b.length ? (a += f(b.join("&")),
                                a += "; expires=" + c.toUTCString(),
            ...
            s: function() {
                try {
                    ...
                    b.push("h=1");
                    var c = b.join("&");
                    "[object String]" === {}.toString.call(this.v) ? this.j([scheme + "//ei.cnzz.com/stat.htm?" + c]) : this.D || this.u ? this.j([scheme + "//ca.cnzz.com/stat.htm?" + c]) : (this.X && this.j([scheme + "//" + this.X + "/stat.htm?" + c]),
                    this.aa && this.j([scheme + "//" + this.aa + "/stat.htm?" + c]))
                } catch (d) {
                    g(d, "sD failed")
                }
            },
